...
class _DesignCalculationScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final optimizationResult = _optimizationEngine.optimizeColumnSection(
      pu: state.pu,
      mx: state.mx,
      my: state.my,
    ...
    final advisorResult = ref
        ...
        .advise(category: 'column', optimizationResult: optimizationResult);
        ...
        children: [
          ...
          OptimizationList(
            ...
            onOptionSelected: (option) {
              final b = option.parameters['b'] as double;
              final d = option.parameters['d'] as double;
              notifier.updateInput(b: b, d: d);
