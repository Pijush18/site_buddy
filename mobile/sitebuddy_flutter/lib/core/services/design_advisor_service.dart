...
class DesignAdvisorService {
  ...
  DesignAdvisorResult advise({
    ...
    if (optimizationResult.options.isEmpty) {
      return const DesignAdvisorResult(
        recommendedOption: null,
        explanation: 'The current design parameters do not satisfy safety requirements (deflection or capacity).',
        warnings: [
          'ACTION REQUIRED: Concrete section is insufficient for the given span and load.'
        ],
        suggestions: [
          'Increase slab thickness significantly.',
          'Consider reducing span or using a continuous slab (two-way) if possible.',
        ],
      );
    }
